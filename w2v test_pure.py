...
heldout_folder = "C:/Users/dilab/PycharmProjects/word2vec/data/1-billion-word-language-modeling-benchmark-r13output/heldout-monolingual.tokenized.shuffled/"
training_folder = "C:/Users/dilab/PycharmProjects/word2vec/data/1-billion-word-language-modeling-benchmark-r13output/training-monolingual.tokenized.shuffled/"
...
with open("C:/Users/dilab/PycharmProjects/word2vec/data/1billion-preprocessed_data.bin", "rb") as f:
...
class Vocab:
    def __init__(self, fi, min_count):
        ...
        fi_vocab_hash = {}
        word_count = 0
        fi = open(fi, 'r', encoding='UTF-8') ## fi는 파일이름, 파일이름을 담은 변수
...
def train_process(pid): #pid는 range(num_processes)
    ...
    analogy_data_semantic, analogy_voca_semantic = test_dataset('C:/Users/dilab/PycharmProjects/word2vec/analogy task_semantic.txt', vocab_list)
    analogy_data_syntactic, analogy_voca_syntactic = test_dataset('C:/Users/dilab/PycharmProjects/word2vec/analogy task_syntactic.txt', vocab_list)
    while fi.tell() < end:
...
def save(syn0, syn1):
    with open('C:/Users/dilab/PycharmProjects/word2vec/model/first_syn0.bin','wb') as f1:
        pickle.dump(syn0,f1)
    with open('C:/Users/dilab/PycharmProjects/word2vec/model/first_syn1.bin','wb') as f2:
        pickle.dump(syn1,f2)
...
def load():
    with open('C:/Users/dilab/PycharmProjects/word2vec/model/first_syn0.bin','rb') as f1:
        syn0 = pickle.load(f1)
    with open('C:/Users/dilab/PycharmProjects/word2vec/model/first_syn1.bin','rb') as f2:
        syn1 = pickle.load(f2)
